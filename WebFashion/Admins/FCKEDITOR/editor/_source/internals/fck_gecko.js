		...
		case 'Paste' :
			try
			{
				...
				if ( FCKConfig.ForcePasteAsPlainText )
					...
					FCKDialog.OpenDialog( 'FCKDialog_Paste', FCKLang.Paste, 'dialog/fck_paste.htm', 400, 330, 'Security' ) ;
			}
			break ;
		default :
...
FCK.PasteAsPlainText = function()
{
	...
	FCKTools.RunFunction( FCKDialog.OpenDialog, FCKDialog, ['FCKDialog_Paste', FCKLang.PasteAsText, 'dialog/fck_paste.htm', 400, 330, 'PlainText'] ) ;
