<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListCategorySubSub.aspx.cs" Inherits="Admins_MenuSub_ListMenuSub" %>
...
<head runat="server">
    <title>Danh mục sản phẩm cấp 3</title>
...
<body onload="InitListMenuSubSub();">
					...
					<div class="section_content">
						...
						<div class="section_content_inner">
						        <table style="display:none;">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <input onclick="InitListMenuSubSub();" type="button" value="Tìm kiếm" style="margin-left:60px;" />
                                        </td>
                                   </tr>
                                </table>
							<div class="table_tabs_menu">
							    <a href="<%=pathAdmin%>/MenuSubSub/AddNew.aspx" class="update"><span><span><em>Nhập mới</em><strong></strong></span></span></a>
							    <a href="javascript:void(0);" onclick="return ajxMenuSubSub.ChangeStatus();" class="update" style="margin-left:3px;"><span><span>Thay đổi<strong></strong></span></span></a>
