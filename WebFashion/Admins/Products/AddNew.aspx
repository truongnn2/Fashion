            	            ...
            	            <div class="section_content_inner">
            	                <table style="width:900px">
            	                    ...
            	                    <tr>
            	                     ...
            	                     <tr>
            	                        <td>
            	                            <label><strong>Danh mục sản phẩm cấp 1:</strong></label>
            	                        </td>
            	                        <td>
            	                    ...
            	                    <tr style="display:none;">
            	                        ...
            	                        <td>
            	                               <select name="sltCategoryDetailSub" style="WIDTH:150px" id="sltCategoryDetailSub" runat="server" onchange="changeSelect('sltCategoryDetailSub','hdCategoryDetailSub');">
                                                </select>
            	                        </td>
            	                    </tr>
            	                    <tr>
            	                    ...
            	                    <tr>
            	                        ...
            	                        <td>
            	                              <input id="txtPromotionPrice" type="text" class="text-long" runat="server" style="width: 334px" />
            	                        </td>
            	                    </tr>
            	                    <tr >
            	                        <td>
            	                    ...
            	                    <tr>
            	                        <td>
            	                            <label><strong>Sản phẩm khuyến mãi:</strong></label>
            	                        </td>
            	                        <td>
            	                     ...
            	                     <tr>
            	                        <td>
            	                            <label><strong>Sản phẩm xem nhiều nhất:</strong></label>
            	                        </td>
            	                        <td>
            	                               <asp:CheckBox ID="chkIsMostView" runat="server" />
            	                        </td>
            	                    </tr>
            	                     <tr>
            	                        <td>
            	                            <label><strong>Sản phẩm mới:</strong></label>
            	                        </td>
            	                        <td>
