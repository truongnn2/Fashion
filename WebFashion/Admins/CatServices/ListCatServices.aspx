<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListCatServices.aspx.cs" Inherits="Admins_CatServices_ListCatServices" %>
...
<body onload="InitListCatServices();">
					...
					<div class="section_content">
						...
						<div class="section_content_inner">
							<div class="table_tabs_menu">
							    <a href="<%=pathAdmin%>/CatServices/AddNew.aspx" class="update"><span><span><em>Nhập mới</em><strong></strong></span></span></a>
							    <a href="javascript:void(0);" onclick="return ajxCatServices.ChangeStatus();" class="update" style="margin-left:3px;"><span><span>Thay đổi<strong></strong></span></span></a>
