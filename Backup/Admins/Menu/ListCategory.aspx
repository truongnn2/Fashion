<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListCategory.aspx.cs" Inherits="Admins_Menu_ListMenu" %>
...
<head runat="server">
    ...
    <script type="text/javascript"  src="<%=pathAdmin%>/js/Menu.js"></script>
    <script type="text/javascript"  src="<%=pathAdmin%>/js/DivPage.js"></script>
</head>
<body onload="InitListMenu();">
					...
					<div class="section_content">
						...
						<div class="section_content_inner">
							<div class="table_tabs_menu">
							    <a href="<%=pathAdmin%>/Menu/AddNew.aspx" class="update"><span><span><em>Nhập mới</em><strong></strong></span></span></a>
							    <a href="javascript:void(0);" onclick="return ajxMenu.ChangeStatus();" class="update" style="margin-left:3px;"><span><span>Thay đổi<strong></strong></span></span></a>
