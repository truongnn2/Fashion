...
<head runat="server">
    <title>Nhập mới danh mục cấp 3</title>
    <script type="text/javascript"  src="<%=pathAdmin%>/js/MenuSubSub.js"></script>
            	            ...
            	            <div class="section_content_inner">
            	                <table>
            	                    ...
            	                    <tr>
            	                        ...
            	                        <td>
            	                            <select name="sltCategory" style="WIDTH:200px" id="sltCategory" runat="server" onchange="ajxMenuSubSub.GetListCatDetail();" >
                                            </select>
            	                        </td>
            	                    </tr>
            	                     <tr>
            	                        ...
            	                        <td>
            	                            <select name="sltCategorySub" style="WIDTH:200px" id="sltCategorySub" runat="server" onchange="changeSelect('sltCategorySub','hdCategoryDetail');">
                                            </select>
            	                        </td>
            	                    </tr>
            	                    <tr>
            	                    ...
            	                    <tr>
            	                        <td colspan="2">
            	                            <input id="Addnew" type="submit" value="Nhập" runat="server" onclick="return AddNewMenuSubSub();" style="margin-top:10px;" onserverclick="Addnew_ServerClick" /><INPUT id="btexit" onclick="javascript:location='ListCategorySubSub.aspx';" tabIndex="9" type="button" value="Hủy" name="btexit" />
            	                        </td>
