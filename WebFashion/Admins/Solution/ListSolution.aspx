<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListSolution.aspx.cs" Inherits="Admins_Solution_ListSolution" %>
...
<head runat="server">
    ...
    <script type="text/javascript"  src="<%=pathAdmin%>/js/Solution.js"></script>
						...
						<div class="section_content_inner">
						        ...
						        <table class="tblheader">
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td colspan="2">
                                            <input onclick="InitlistSolution();" type="button" value="Tìm kiếm" style="margin-left:60px;" />
                                        </td>
                                   </tr>
                                </table><br/>
							<div class="table_tabs_menu">
							    <a href="<%=pathAdmin%>/Solution/AddNew.aspx" class="update"><span><span><em>Nhập mới</em><strong></strong></span></span></a>
							    <a href="javascript:void(0);" onclick="return ajxSolution.ChangeStatus();" class="update" style="margin-left:3px;"><span><span>Thay đổi<strong></strong></span></span></a>
