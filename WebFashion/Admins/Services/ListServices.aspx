<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListServices.aspx.cs" Inherits="Admins_Services_ListServices" %>
						...
						<div class="section_content_inner">
						        ...
						        <table class="tblheader">
                                    <tr>
                                        ...
                                        <td><label>Danh mục dịch vụ cấp 1:</label></td>
                                        <td><select name="sltCategory" style="WIDTH:150px" id="sltCategory" runat="server"  onchange="ajxServices.GetListCatSubServices();">
                                        </select></td>
                                         <td><label>Danh mục dịch vụ cấp 2:</label></td>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td colspan="2">
                                            <input onclick="InitlistServices();" type="button" value="Tìm kiếm" style="margin-left:60px;" />
                                        </td>
                                   </tr>
                                </table><br/>
							<div class="table_tabs_menu">
							    <a href="<%=pathAdmin%>/Services/AddNew.aspx" class="update"><span><span><em>Nhập mới</em><strong></strong></span></span></a>
							    <a href="javascript:void(0);" onclick="return ajxServices.ChangeStatus();" class="update" style="margin-left:3px;"><span><span>Thay đổi<strong></strong></span></span></a>
