<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListSupportOnline.aspx.cs" Inherits="Admins_ListSupportOnline" %>
...
<head runat="server">
    <title>Danh sách hỗ trợ trực tuyến</title>
...
<body onload="InitListSupportOnline();">
					...
					<div class="title_wrapper">
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								<h2>Danh sách hỗ trợ trực tuyến:</h2>
							</div>
						</div>
					...
					<div class="section_content">
						...
						<div class="section_content_inner">
							<div class="table_tabs_menu">
							    <a href="<%=pathAdmin%>/SupportOnline/AddNew.aspx" class="update"><span><span><em>Nhập mới</em><strong></strong></span></span></a>
							    <a href="javascript:void(0);" onclick="return ajxSupportOnline.ChangeStatus();" class="update" style="margin-left:3px;"><span><span>Thay đổi<strong></strong></span></span></a>
