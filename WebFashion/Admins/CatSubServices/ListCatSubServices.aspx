<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListCatSubServices.aspx.cs" Inherits="Admins_CatSubServices_ListCatSubServices" %>
...
<head runat="server">
    <title>Danh mục dịch vụ cấp 2</title>
...
<body onload="InitListCatSubServices();">
					...
					<div class="section_content">
						...
						<div class="section_content_inner">
						        <table style="display:none;">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <input onclick="InitListCatServices();" type="button" value="Tìm kiếm" style="margin-left:60px;" />
                                        </td>
                                   </tr>
                                </table>
							<div class="table_tabs_menu">
							    <a href="<%=pathAdmin%>/CatSubServices/AddNew.aspx" class="update"><span><span><em>Nhập mới</em><strong></strong></span></span></a>
							    <a href="javascript:void(0);" onclick="return ajxCatSubServices.ChangeStatus();" class="update" style="margin-left:3px;"><span><span>Thay đổi<strong></strong></span></span></a>
