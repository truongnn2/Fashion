					...
					<div class="section_content">
						...
						<div class="section_content_inner">
						    <table class="style2" cellSpacing="1" cellPadding="0" style="width:900px;" border="0">
								...
								<tr class="br6">
									<td >
                                        <fckeditorv2:fckeditor id="txtNoidung" runat="server" BasePath="./../FCKeditor/" Height="500px"></fckeditorv2:fckeditor></td>
								</tr>
								<tr class="br6">
								...
								<tr class="br6">
									<td >
                                        <fckeditorv2:fckeditor id="txtContent" runat="server" BasePath="./../FCKeditor/" Height="500px"></fckeditorv2:fckeditor></td>
								</tr>
								<tr class="br1">
