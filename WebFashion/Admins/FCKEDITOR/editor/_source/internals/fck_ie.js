...
FCK._ExecPaste = function()
{
	...
	if ( sHTML === false )
		FCKTools.RunFunction( FCKDialog.OpenDialog, FCKDialog, ['FCKDialog_Paste', FCKLang.Paste, 'dialog/fck_paste.htm', 400, 330, 'Security'] ) ;
	else
	{
...
FCK.PasteAsPlainText = function( forceText )
{
	...
	{
		FCKDialog.OpenDialog( 'FCKDialog_Paste', FCKLang.PasteAsText, 'dialog/fck_paste.htm', 400, 330, 'PlainText' ) ;
		return ;
	}
