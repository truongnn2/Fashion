            	        ...
            	        <div class="section_content">
            	            ...
            	            <div class="section_content_inner">
            	                <table>
            	                    ...
            	                    <tr>
            	                        <td>
            	                            <input id="Addnew" type="submit" value="Nhập mới" runat="server" onclick="return AddNewSolution();" style="margin-top:10px;" onserverclick="Addnew_ServerClick" /><INPUT id="Button1" onclick="javascript:location='ListProducts.aspx';" tabIndex="9" type="button" value="Hủy" name="btexit" />
