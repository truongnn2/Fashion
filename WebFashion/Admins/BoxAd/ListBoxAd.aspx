<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListBoxAd.aspx.cs" Inherits="Admins_News_ListNews" %>
...
<head runat="server">
    <title>Danh sách box quảng cáo</title>
					...
					<div class="section_content">
						...
						<div class="section_content_inner">
							...
							<div class="table_tabs_menu">
							    <a href="<%=pathAdmin%>/BoxAd/AddNew.aspx" class="update"><span><span><em>Nhập mới</em><strong></strong></span></span></a>
							    <a href="javascript:void(0);" onclick="return ajxBoxAd.ChangeStatus();" class="update" style="margin-left:3px;"><span><span>Thay đổi<strong></strong></span></span></a>
