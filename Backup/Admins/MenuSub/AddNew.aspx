...
<head runat="server">
    <title>Nhập mới danh mục chi tiết</title>
                        ...
                        <div class="title_wrapper">
						    ...
						    <div class="title_wrapper_inner">
							    ...
							    <div class="title_wrapper_content">
								    <h2>Nhập mới danh mục chi tiết</h2>
							    </div>
						    </div>
            	        ...
            	        <div class="section_content">
            	            ...
            	            <div class="section_content_inner">
            	                <table>
            	                    ...
            	                    <tr>
            	                        <td colspan="2">
            	                            <input id="Addnew" type="submit" value="Nhập" runat="server" onclick="return AddNewMenuSub();" style="margin-top:10px;" onserverclick="Addnew_ServerClick" /><INPUT id="btexit" onclick="javascript:location='ListCategorySub.aspx';" tabIndex="9" type="button" value="Hủy" name="btexit" />
            	                        </td>
