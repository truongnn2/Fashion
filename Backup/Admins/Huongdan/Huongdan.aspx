<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Huongdan.aspx.cs" Inherits="Huongdan" ValidateRequest="false"%>
					...
					<div class="section_content">
						...
						<div class="section_content_inner">
						    <table cellSpacing="1" cellPadding="0" style="width:800px;" border="0">
								...
								<tr >
									<td align="center" >
										<INPUT id="btexit" onclick="javascript:location='Edit.aspx?id=1';" tabIndex="9" type="button" value="Hiệu chỉnh"
												name="btexit" />&nbsp;
									</td>
								</tr>
							</table>
